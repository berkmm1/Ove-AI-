...
export const ChatArea: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full w-full">
      {/* Header */}
      <header className="flex h-14 shrink-0 items-center justify-between border-b border-border bg-background/95 backdrop-blur px-4 md:px-6">
        <div className="flex items-center gap-2">
          {/* Add optional header items here later if needed */}
        </div>
      </header>
      ...
      <div className="flex-1 overflow-y-auto">
        {messages.length === 0 ? (
          <div className="flex h-full flex-col items-center justify-center p-8 text-center">
            ...
            <h1 className="mb-2 text-2xl font-semibold text-foreground">DeepSeek Klonu</h1>
