      ...
      <div className="mx-auto max-w-4xl">
        <div className="relative flex flex-col w-full rounded-2xl border border-border bg-muted/20 p-2 shadow-sm focus-within:ring-1 focus-within:ring-primary/50 focus-within:border-primary/50 transition-all">
          <textarea
            ...
            className="max-h-[200px] min-h-[40px] w-full resize-none bg-transparent py-2.5 px-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none"
            rows={1}
            disabled={isSending}
          />
          ...
          <div className="flex items-center justify-between pt-2">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <Send size={14} className={cn(input.trim() && !isSending && "translate-x-[1px]")} />
              </button>
            </div>
          </div>
        </div>
