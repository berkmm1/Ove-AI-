      ...
      <div className="mx-auto max-w-4xl">
        <div className="relative flex flex-col w-full rounded-2xl border border-border bg-muted/20 shadow-sm focus-within:ring-1 focus-within:ring-primary/50 focus-within:border-primary/50 transition-all">
          ...
          <textarea
            ...
            className="max-h-[200px] min-h-[40px] w-full resize-none bg-transparent px-4 py-4 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none"
            rows={1}
            disabled={isSending}
          />
