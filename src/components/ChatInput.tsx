  ...
  return (
    <div className="w-full bg-background pt-2 pb-6 px-4 md:px-6">
      <div className="mx-auto max-w-4xl">
        <div className="relative flex flex-col w-full rounded-2xl border border-border bg-muted/50 p-3 shadow-sm focus-within:ring-1 focus-within:ring-primary/50 focus-within:border-primary/50 transition-all">
