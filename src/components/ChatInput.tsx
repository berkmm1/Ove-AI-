  ...
  return (
    <div className="w-full bg-background pt-2 pb-6 px-4 md:px-6">
      <div className="mx-auto max-w-3xl">
        <div className="flex flex-col w-full rounded-2xl border border-border bg-muted/20 shadow-sm focus-within:ring-1 focus-within:ring-primary/50 focus-within:border-primary/50 transition-all overflow-hidden">
          <div className="flex items-center px-3 pt-3 gap-2">
            <button
            ...
            >
              <Globe size={14} className={cn(settings.useWebSearch && "text-primary")} />
              Arama
            </button>
          </div>
          ...
          <textarea
            ...
            placeholder="DeepSeek'e mesaj gönder..."
            className="max-h-[200px] min-h-[44px] w-full resize-none bg-transparent px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none"
            rows={1}
            disabled={isSending}
          />
