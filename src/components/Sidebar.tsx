...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed inset-y-0 left-0 z-30 flex w-64 flex-col bg-background border-r border-border transition-transform duration-300 md:static md:translate-x-0",
        ...
        <div className={cn("flex flex-col h-full", !isOpen && "md:hidden")}>
          <div className="p-3">
            <button
              ...
              className="flex w-full items-center justify-between rounded-lg bg-muted/50 border border-border px-3 py-3 text-sm font-medium text-foreground hover:bg-muted transition-colors"
            >
