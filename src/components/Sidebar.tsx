        ...
        <div className={cn("flex flex-col h-full", !isOpen && "md:hidden")}>
          <div className="p-4">
            <button
              ...
              className="flex w-full items-center justify-between rounded-lg bg-background border border-border px-4 py-2.5 text-sm font-medium text-foreground hover:bg-muted/50 transition-colors shadow-sm"
            >
          ...
          <div className="flex-1 overflow-y-auto px-4 pb-4">
            <div className="text-xs font-medium text-muted-foreground mb-3 px-1">Geçmiş Sohbetler</div>
